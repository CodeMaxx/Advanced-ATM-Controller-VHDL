				...
				if((buffer==0x01) | (buffer==0x02)){
					...
					if(buffer==buffer2){
						...
						if(buffer==buffer3){
							...
							message = 0x01;
                            fStatus = flWriteChannel(handle, (uint8) 127, 1, &message, &error);
                            CHECK_STATUS(fStatus, FLP_LIBERR, cleanup);
////////////////////////////////Advanced///////////////////////////////////
                            // uint8 one = 0x1;
							...
							uint32 res_total = UINT_MAX; // TODO - Will have to change this in VHDL.
...
////////////////////////////////Advanced///////////////////////////////////
							...
							uint16 check_bank2 = (ID << 11 | ID >> 5);
							uint8 check_bank = check_bank2 >> 11;
							printf("%u %u\n",ID,PIN );
							printf("%u \n",check_bank );
